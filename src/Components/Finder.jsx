      ...
      >
        ...
        <div className="w-2/3 bg-white rounded-br-xl relative">
          ...
          <div
            ...
            className={`aspect-9/16 flex left-10 top-20 items-center justify-center flex-col w-20 p-1 h-32 rounded-xs absolute scale-120 transition-all hover:bg-black/5 ${
              isActive && "bg-black/5"
            }`}
          >
