...
import { FolderClock, Clock, ChevronLeft } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="w-2/3 bg-white rounded-br-xl relative">
        ...
        <div className="aspect-9/16 flex left-10 top-20 items-center justify-center flex-col w-20 hover:bg-black/20 p-1 h-32 rounded-xs absolute scale-120 transition-all">
          <img src="/paper.png" alt="paper-profile" />
          <p className="text-zinc-700 text-[10px] font-medium">
            My Profile.pdf
          </p>
          <p className="text-zinc-500 text-[7px]">05/10/25, 12.01AM</p>
          <p className="text-zinc-500 text-[7px]">500KB</p>
        </div>
      </div>
    </div>
  );
