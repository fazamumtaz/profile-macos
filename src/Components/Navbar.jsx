  ...
  return (
    <nav className="fixed w-full h-8 bg-white/40 backdrop-blur-xs flex items-center justify-between px-3">
      ...
      <ul className="flex gap-1 items-center px-2">
        <li className="py-0.5 px-2 hover:bg-black/10 cursor-default rounded-sm">
        ...
        <li className="py-0.5 px-2 hover:bg-black/10 cursor-default rounded-sm mx-1 font-semibold">
          Finder
        </li>
